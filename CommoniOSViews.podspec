...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CommoniOSViews.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Sharif Khaleel/CommoniOSViews'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Sharif Khaleel' => 'll.hawk.ll@gmail.com' }
  s.source           = { :git => 'https://github.com/Sharif Khaleel/CommoniOSViews.git', :tag => s.version.to_s }
